 ...
 * @author JKRANES
 */
public abstract class JpdlNodeBuilderFactory<T extends NodeBuilder, S extends Activity> extends AbstractNodeBuilderFactory<T, S> {

    public JpdlNodeBuilderFactory(NodeType nodeType) {
        super(nodeType, JpdlProcessContext.class);
    }
