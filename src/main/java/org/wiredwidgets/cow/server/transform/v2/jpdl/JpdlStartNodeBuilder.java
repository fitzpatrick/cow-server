 ...
 * @author JKRANES
 */
public class JpdlStartNodeBuilder extends JpdlNodeBuilder<Process.Start, Activity> {

    public JpdlStartNodeBuilder(ProcessContext context) {
        super(context, new Process.Start(), null);
    }
