...
public class LogNotifier implements Notifier {
    ...
    public void sendNotice(NoticeMessage message) {
        log.info("Process: " + message.getProcessId());
        log.info("Activity: " + message.getActivityName());
        log.info("Participant: " + message.getParticipant());
        log.info("Type: " + message.getParticipantType());
    }
