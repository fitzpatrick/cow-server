 ...
 * @author JKRANES
 */
public class JbpmToSc2ProcessInstance implements Converter<org.jbpm.api.ProcessInstance, ProcessInstance> {
    ...
    @Override
    public ProcessInstance convert(org.jbpm.api.ProcessInstance source) {
